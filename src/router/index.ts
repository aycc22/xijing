...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/exam-result/:sessionId/review',
      name: 'exam-result-review',
      component: () => import('../views/ExamResultReviewView.vue'),
      meta: { auth: true },
    },
    {
    ...
    {
      path: '/result/:sessionId/review',
      name: 'result-review',
      component: () => import('../views/ResultReviewView.vue'),
      meta: { auth: true },
    },
